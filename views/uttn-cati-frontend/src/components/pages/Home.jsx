...
export const Home = () => {
  ...
  const { data, loading } = useFetch(
    "http://localhost:3000/api/device/search/" + params.seleccion
  );
  ...
  const doSearch = (e) => {
    e.preventDefault;
    let entry = e.target.search_entry.value;
    redirect("/Buscar/" + entry, { replace: true });
  };
    ...
    <div className="content">
      <div className="filter">
        <div className="searchbarSection">
          ...
          <form onSubmit={doSearch} className="searchbarForm">
            <input
              type="text"
              className="searchbar"
              name="search_entry"
              placeholder="Departamento, Encargado, ID, Modelo..."
            ></input>
